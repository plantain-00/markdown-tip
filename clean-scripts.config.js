...
const vueTemplateCommand = `file2variable-cli packages/vue/src/index.template.html -o packages/vue/src/variables.ts --html-minify --base packages/vue/src/ --vue --vue-type-name "MarkdownTip" --vue-type-path "./index"`
